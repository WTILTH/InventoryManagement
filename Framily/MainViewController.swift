...
extension MainViewController: SideMenuViewControllerDelegate {
        ...
        func selectedCell(_ row: Int) {
                // Determine the storyboard ID of the corresponding view controller based on the selected cell
                let storyboardID: String
                switch row {
                case 0: // Home
                    storyboardID = "HomeNavID"
                case 1: // Music
                    storyboardID = "MusicNavID"
                case 2: // Movies
                    storyboardID = "MoviesNavID"
                case 3: // Books
                    storyboardID = "BooksNavID"
                case 4: // Profile
                    storyboardID = "ProfileNavID"
                case 5: // Settings
                    storyboardID = "SettingsNavID"
                default:
                    return
                }
                
                // Show the corresponding view controller
